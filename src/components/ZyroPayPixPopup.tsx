...
interface ZyroPayPixPopupProps {
...
const ZyroPayPixPopup = ({ amount, description, onSuccess, onClose }: ZyroPayPixPopupProps) => {
  ...
  useEffect(() => {
    ...
    const createPayment = async () => {
      try {
        ...
        console.log("Creating ZyroPay payment:", { amount, description });
...
export default ZyroPayPixPopup;
